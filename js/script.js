...
var lyrMarkerJobOpeningsCluster = L.markerClusterGroup({ showCoverageOnHover: false });
var lyrMarkerSchoolsCluster = L.markerClusterGroup({ showCoverageOnHover: false });
...
$("input[type='checkbox'][name='filter-by-first-type-input']").click(
  function () {
    ...
    if ($(this).is(":checked")) {
      $("[data-first-type='" + currentSelection + "']").each(function (index) {
